                    ...
                    while (opcionJugos >= 1 && opcionJugos <= 3) {
                        switch (opcionJugos) {
                            ...
                            case 3://modificar
                                ...
                                while (opcionModificar == 1 || opcionModificar == 2) {//cambiar sabores
                                        ...
                                        case 1:
                                            ...
                                            if (datosSPJ.busquedaJugosC(buscarIdJugo) == true) {
                                                if (datosJugos.buscar(buscarIdJugo) == true) {
                                                    ...
                                                    datosJugos.buscar(idJugoVerdadera);
                                                    System.out.println("hola mundo, la id es " + idJugoVerdadera);
